...
st.markdown("#red[ ค่านวณคาดัชนีมวลกาย BMI]")
...
if bmi 18.5:
    warning("คุณมีน้ำหนักน้อยกว่าเกณฑ์ (ผอม)📏")

elif 18.5 <= bmi < 23.0:
    st.success(" คุณมีน้ำหนักอยู่ในเกณฑ์ปกติ (สุขภาพดี)🍎")

elif 23.0 <= bmi < 25.0:
    st.info(" คุณเริ่มมีน้ำหนักเกินเกลเฑ์ (ท้วม)💧")
else:
    st.error(" คุณอยู่ในเกณฑ์อ้วน ควรระวังเรื่องสุขภาพและออกกำลังกาย🚨 ")

st.divider()
st.write("นางสาวนิธินาถ พัฒนบุญแสน เลขที่ 30 ม.4/3")
